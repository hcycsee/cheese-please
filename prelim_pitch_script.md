...
| 1:20–1:35 | Click "Add friend" → cut to Friends page, accept a request → open a DM chat, send a message, then drop in a GIF from the attach button. | **VO:** "Add people, chat instantly — drop in a photo or a GIF just as easily as typing — and start actually talking." |
...
| 2:22–2:32 | Quick montage: profile page — upload an avatar, type a bio, toggle a chip's visibility off, flip dark mode on with the floating toggle — then a chat's "⋯" menu opening to flip the "online in Minecraft" demo toggle. | **VO:** "Make it yours — a profile picture, a bio, control over exactly what other people can see — down to a little toggle showing how a game like Minecraft could plug into your live status." |
| 2:32–2:38 | Cut back to Hubert from the opening shot — same table, same J03 9th floor — but now his laptop screen shows an active UNIPIXEL group chat, and he's smiling, looking up like someone's about to sit down. | **VO:** "Because finding your people shouldn't be this hard." |
| 2:38–2:44 | Logo returns, centred, with tagline underneath. | **On-screen text:** "UNIPIXEL — find your people." |
| 2:44–2:50 | Fade to team credit card. | **On-screen text:** "Built at Syncs Hack 2026" |

---

## Production notes

- **Pacing check:** roughly 300 words of VO across 2:50 is still a relaxed, conversational pace (well under the ~400–450 words a 3-minute video can hold at normal delivery) — there's room to breathe on the screen-capture beats, and a few seconds of margin before the 3:00 cutoff. If a rehearsal read-through runs long, trim narration before cutting demo time.
- **The beat to protect above all others if the edit runs long:** the games segment (1:35–2:00) — it's the clearest "nobody else in this room built that" moment. Trim the profile montage or the closing callback shot before touching it.
- **Live footage needed:** registration flow, dashboard filter interaction, a DM being sent, dropping a GIF into a chat, all three minigames in action, the match page toggles + result, profile page (avatar/bio/visibility), dark mode toggle, and a chat's "⋯" menu with the Minecraft demo toggle.
- **Freeze frame/bookend:** reusing the opening J03 shot at 2:32 for the "resolution" beat is optional but a nice touch if the footage allows it — ties the story back together without needing new VO to explain it.
...
|---|---|
| **Level of innovation** | 0:38–0:48 explicitly contrasts UNIPIXEL against swipe apps and generic Discord servers. 1:35–2:00 (in-chat multiplayer games) is the clearest "nobody else does this" moment — protect this beat above all others. |
| **Technical complexity** | 1:35–2:00 calls out that the games are real-time multiplayer built from scratch, not a bolted-on third party. 2:00–2:22 calls out the live matching engine. If time allows in the final live pitch, be ready to go deeper here (custom Socket.IO server, the weighted matching algorithm, privacy-preserving chip visibility) — the video hints at it, the Q&A can prove it. |
